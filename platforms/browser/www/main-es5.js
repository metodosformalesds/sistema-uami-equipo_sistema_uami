...
var routes = [
    ...
    { path: 'login', loadChildren: function () { return Promise.all(/*! import() | login-login-module */[__webpack_require__.e("common"), __webpack_require__.e("login-login-module")]).then(__webpack_require__.bind(null, /*! ./login/login.module */ "./src/app/login/login.module.ts")).then(function (m) { return m.LoginPageModule; }); } },
    {
        path: 'menu',
        loadChildren: function () { return Promise.all(/*! import() | menu-menu-module */[__webpack_require__.e("common"), __webpack_require__.e("menu-menu-module")]).then(__webpack_require__.bind(null, /*! ./menu/menu.module */ "./src/app/menu/menu.module.ts")).then(function (m) { return m.MenuPageModule; }); }
    },
    {
        path: 'consulta',
        loadChildren: function () { return Promise.all(/*! import() | consulta-consulta-module */[__webpack_require__.e("common"), __webpack_require__.e("consulta-consulta-module")]).then(__webpack_require__.bind(null, /*! ./consulta/consulta.module */ "./src/app/consulta/consulta.module.ts")).then(function (m) { return m.ConsultaPageModule; }); }
    },
    {
    ...
    },
    {
        ...
        loadChildren: function () { return Promise.all(/*! import() | registro-paciente-registro-paciente-module */[__webpack_require__.e("common"), __webpack_require__.e("registro-paciente-registro-paciente-module")]).then(__webpack_require__.bind(null, /*! ./registro-paciente/registro-paciente.module */ "./src/app/registro-paciente/registro-paciente.module.ts")).then(function (m) { return m.RegistroPacientePageModule; }); }
    },
    {
        path: 'registro-usuario',
        loadChildren: function () { return Promise.all(/*! import() | registro-usuario-registro-usuario-module */[__webpack_require__.e("common"), __webpack_require__.e("registro-usuario-registro-usuario-module")]).then(__webpack_require__.bind(null, /*! ./registro-usuario/registro-usuario.module */ "./src/app/registro-usuario/registro-usuario.module.ts")).then(function (m) { return m.RegistroUsuarioPageModule; }); }
    },
    {
        path: 'registro-medicamento',
        loadChildren: function () { return Promise.all(/*! import() | registro-medicamento-registro-medicamento-module */[__webpack_require__.e("common"), __webpack_require__.e("registro-medicamento-registro-medicamento-module")]).then(__webpack_require__.bind(null, /*! ./registro-medicamento/registro-medicamento.module */ "./src/app/registro-medicamento/registro-medicamento.module.ts")).then(function (m) { return m.RegistroMedicamentoPageModule; }); }
    },
    {
    ...
    },
    {
        ...
        loadChildren: function () { return Promise.all(/*! import() | reporte-medicamento-reporte-medicamento-module */[__webpack_require__.e("common"), __webpack_require__.e("reporte-medicamento-reporte-medicamento-module")]).then(__webpack_require__.bind(null, /*! ./reporte-medicamento/reporte-medicamento.module */ "./src/app/reporte-medicamento/reporte-medicamento.module.ts")).then(function (m) { return m.ReporteMedicamentoPageModule; }); }
    },
    {
        path: 'reporte-enfermedades',
        loadChildren: function () { return __webpack_require__.e(/*! import() | reporte-enfermedades-reporte-enfermedades-module */ "reporte-enfermedades-reporte-enfermedades-module").then(__webpack_require__.bind(null, /*! ./reporte-enfermedades/reporte-enfermedades.module */ "./src/app/reporte-enfermedades/reporte-enfermedades.module.ts")).then(function (m) { return m.ReporteEnfermedadesPageModule; }); }
    },
    {
        path: 'listado-paciente',
        loadChildren: function () { return Promise.all(/*! import() | listado-paciente-listado-paciente-module */[__webpack_require__.e("common"), __webpack_require__.e("listado-paciente-listado-paciente-module")]).then(__webpack_require__.bind(null, /*! ./listado-paciente/listado-paciente.module */ "./src/app/listado-paciente/listado-paciente.module.ts")).then(function (m) { return m.ListadoPacientePageModule; }); }
    },
    {
        path: 'listado-medicamento',
        loadChildren: function () { return Promise.all(/*! import() | listado-medicamento-listado-medicamento-module */[__webpack_require__.e("common"), __webpack_require__.e("listado-medicamento-listado-medicamento-module")]).then(__webpack_require__.bind(null, /*! ./listado-medicamento/listado-medicamento.module */ "./src/app/listado-medicamento/listado-medicamento.module.ts")).then(function (m) { return m.ListadoMedicamentoPageModule; }); }
    },
    {
        path: 'listado-consulta',
        loadChildren: function () { return Promise.all(/*! import() | listado-consulta-listado-consulta-module */[__webpack_require__.e("common"), __webpack_require__.e("listado-consulta-listado-consulta-module")]).then(__webpack_require__.bind(null, /*! ./listado-consulta/listado-consulta.module */ "./src/app/listado-consulta/listado-consulta.module.ts")).then(function (m) { return m.ListadoConsultaPageModule; }); }
    },
    {
        path: 'reporte',
        loadChildren: function () { return Promise.all(/*! import() | reporte-reporte-module */[__webpack_require__.e("common"), __webpack_require__.e("reporte-reporte-module")]).then(__webpack_require__.bind(null, /*! ./reporte/reporte.module */ "./src/app/reporte/reporte.module.ts")).then(function (m) { return m.ReportePageModule; }); }
    },
];
...
firebase__WEBPACK_IMPORTED_MODULE_10__["initializeApp"](_environments_environment__WEBPACK_IMPORTED_MODULE_9__["environment"].firebaseConfig);
...
var environment = {
    production: false,
    firebaseConfig: {
        apiKey: "AIzaSyDHLlxjPW2TqcxLq4nLZCkjsyROnYjQ7Xw",
        authDomain: "uami-eaf8a.firebaseapp.com",
        databaseURL: "https://uami-eaf8a.firebaseio.com",
        projectId: "uami-eaf8a",
        storageBucket: "uami-eaf8a.appspot.com",
        messagingSenderId: "229987418572",
        appId: "1:229987418572:web:d890e2866e43084d381d69"
    }
};
/*
...
module.exports = __webpack_require__(/*! C:\Users\johnc\Documents\Metodos\UAMI\src\main.ts */"./src/main.ts");
