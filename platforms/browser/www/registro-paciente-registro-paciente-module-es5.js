...
var RegistroPacientePageRoutingModule = /** @class */ (function () {
    function RegistroPacientePageRoutingModule() {
    }
    ...
    return RegistroPacientePageRoutingModule;
}());
...
var RegistroPacientePageModule = /** @class */ (function () {
    function RegistroPacientePageModule() {
    }
    ...
    return RegistroPacientePageModule;
}());
...
var RegistroPacientePage = /** @class */ (function () {
    function RegistroPacientePage(navCtrl, BD) {
        this.navCtrl = navCtrl;
        this.BD = BD;
    }
    RegistroPacientePage.prototype.ngOnInit = function () {
    };
    RegistroPacientePage.prototype.guardar = function () {
        this.BD.guardarPaciente(this.matricula, this.carrera, this.edad, this.sexo);
        this.navCtrl.navigateForward('menu');
    };
    RegistroPacientePage.ctorParameters = function () { return [
...
//# sourceMappingURL=registro-paciente-registro-paciente-module-es5.js.map