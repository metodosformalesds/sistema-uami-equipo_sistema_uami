...
var ListadoPacientePageRoutingModule = /** @class */ (function () {
    function ListadoPacientePageRoutingModule() {
    }
    ...
    return ListadoPacientePageRoutingModule;
}());
...
var ListadoPacientePageModule = /** @class */ (function () {
    function ListadoPacientePageModule() {
    }
    ...
    return ListadoPacientePageModule;
}());
...
var ListadoPacientePage = /** @class */ (function () {
    function ListadoPacientePage(navCtrl, BD) {
        this.navCtrl = navCtrl;
        this.BD = BD;
    }
    ListadoPacientePage.prototype.ngOnInit = function () {
        var _this = this;
        this.pacientes = [];
        this.BD.listadoPaciente();
        setTimeout(function (a) { return _this.getPacientes(); }, 500);
        this.BD.ListadoPacientes = [];
    };
    ListadoPacientePage.prototype.getPacientes = function () {
        this.pacientes = this.BD.ListadoPacientes;
        console.log(this.pacientes);
    };
    ListadoPacientePage.prototype.onSearchTerm = function (ev) {
        var val = ev.detail.value;
        if (val && val.trim() !== '') {
            this.pacientes = this.pacientes.filter(function (term) {
    ...
    ListadoPacientePage.prototype.goToConsulta = function (Matricula) {
        this.navCtrl.navigateForward(['/consulta', Matricula]);
    };
    ListadoPacientePage.prototype.goToRegistraPaciente = function () {
        this.navCtrl.navigateForward('registro-paciente');
    };
    ListadoPacientePage.ctorParameters = function () { return [
...
//# sourceMappingURL=listado-paciente-listado-paciente-module-es5.js.map