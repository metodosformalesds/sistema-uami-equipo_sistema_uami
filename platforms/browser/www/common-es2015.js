...
let BDService = class BDService {
    ...
    rol() {
        firebase__WEBPACK_IMPORTED_MODULE_2__["database"]().ref(this.userDetails()).child("ROL").once('value', a => this.rol1(a.val()));
    }
    rol1(a) {
        this.ROL = a;
        console.log(a);
    ...
    crearUsuario(nickname, contrasena, email, rol) {
        firebase__WEBPACK_IMPORTED_MODULE_2__["auth"]().createUserWithEmailAndPassword(email, contrasena).then(a => this.guardarROL(a.user.uid, nickname, rol));
    }
    ...
    listadoMedicamento() {
        firebase__WEBPACK_IMPORTED_MODULE_2__["database"]().ref().child('Medicamento').once('value', ss => {
            ss.forEach(element => {
    ...
    listadoPaciente() {
        firebase__WEBPACK_IMPORTED_MODULE_2__["database"]().ref().child('Paciente').once('value', ss => {
            ss.forEach(element => {
    ...
    listadoConsulta() {
        firebase__WEBPACK_IMPORTED_MODULE_2__["database"]().ref().child('Consulta').once('value', ss => {
            ss.forEach(element => {
