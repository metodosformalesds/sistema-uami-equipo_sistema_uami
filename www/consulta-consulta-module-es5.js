...
var ConsultaPageRoutingModule = /** @class */ (function () {
    function ConsultaPageRoutingModule() {
    }
...
var ConsultaPage = /** @class */ (function () {
    function ConsultaPage(navCtrl, BD, alertCtrl, activeRoute) {
    ...
    ConsultaPage.prototype.listadomed = function () {
        this.medicamentos = this.BD.ListadoMedicamentos;
    };
    ConsultaPage.prototype.guardar = function () {
        var _this = this;
        ...
        var alert = this.alertCtrl.create({
            ...
            buttons: [{
                    text: 'Si',
                    handler: function () {
                        _this.restarMedicamento(_this.medicamentoSelect);
    ...
    ConsultaPage.prototype.restarMedicamento = function (a) {
        this.BD.restarMedicamento(a);
    };
    ConsultaPage.ctorParameters = function () { return [
...
//# sourceMappingURL=consulta-consulta-module-es5.js.map