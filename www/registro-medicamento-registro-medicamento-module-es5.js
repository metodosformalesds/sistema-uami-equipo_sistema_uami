...
var RegistroMedicamentoPageRoutingModule = /** @class */ (function () {
    function RegistroMedicamentoPageRoutingModule() {
    }
    ...
    return RegistroMedicamentoPageRoutingModule;
}());
...
var RegistroMedicamentoPage = /** @class */ (function () {
    function RegistroMedicamentoPage(navCtrl, BD, activeRoute) {
        this.navCtrl = navCtrl;
        this.BD = BD;
        this.activeRoute = activeRoute;
        this.observaciones = "";
    }
    RegistroMedicamentoPage.prototype.ngOnInit = function () {
        this.nombre = this.activeRoute.snapshot.paramMap.get('nombre');
    };
    RegistroMedicamentoPage.prototype.guardarMedicamento = function () {
        this.BD.guardarMedicamento(this.nombre, this.cantidad, this.observaciones);
        this.navCtrl.navigateForward('menu');
    };
    RegistroMedicamentoPage.ctorParameters = function () { return [
...
//# sourceMappingURL=registro-medicamento-registro-medicamento-module-es5.js.map