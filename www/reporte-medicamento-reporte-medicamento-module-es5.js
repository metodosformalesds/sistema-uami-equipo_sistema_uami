...
var ReporteMedicamentoPageRoutingModule = /** @class */ (function () {
    function ReporteMedicamentoPageRoutingModule() {
    }
    ...
    return ReporteMedicamentoPageRoutingModule;
}());
...
var ReporteMedicamentoPageModule = /** @class */ (function () {
    function ReporteMedicamentoPageModule() {
    }
    ...
    return ReporteMedicamentoPageModule;
}());
...
var ReporteMedicamentoPage = /** @class */ (function () {
    function ReporteMedicamentoPage(navCtrl, BD) {
        this.navCtrl = navCtrl;
        this.BD = BD;
    }
    ReporteMedicamentoPage.prototype.ngOnInit = function () {
        var _this = this;
        this.medicamentos = [];
        this.BD.listadoMedicamento();
        setTimeout(function (a) { return _this.getMedicamentos(); }, 500);
    };
    ReporteMedicamentoPage.prototype.getMedicamentos = function () {
        this.medicamentos = this.BD.ListadoMedicamentos;
        console.log(this.medicamentos);
        this.BD.ListadoPacientes = [];
    };
    ReporteMedicamentoPage.prototype.goToMenu = function () {
        this.navCtrl.navigateForward('menu');
    };
    ReporteMedicamentoPage.ctorParameters = function () { return [
...
//# sourceMappingURL=reporte-medicamento-reporte-medicamento-module-es5.js.map