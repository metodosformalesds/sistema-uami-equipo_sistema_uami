...
var ListadoConsultaPageRoutingModule = /** @class */ (function () {
    function ListadoConsultaPageRoutingModule() {
    }
    ...
    return ListadoConsultaPageRoutingModule;
}());
...
var ListadoConsultaPageModule = /** @class */ (function () {
    function ListadoConsultaPageModule() {
    }
    ...
    return ListadoConsultaPageModule;
}());
...
var ListadoConsultaPage = /** @class */ (function () {
    function ListadoConsultaPage(navCtrl, BD) {
        this.navCtrl = navCtrl;
        this.BD = BD;
    }
    ListadoConsultaPage.prototype.ngOnInit = function () {
        var _this = this;
        this.consultas = [];
        this.BD.listadoConsulta();
        setTimeout(function (a) { return _this.getConsultas(); }, 500);
        this.BD.ListadoConsultas = [];
    };
    ListadoConsultaPage.prototype.goToModificarConsulta = function (matricula, id) {
        console.log(matricula);
        console.log(id);
        this.navCtrl.navigateForward(['/consulta', { matricula: matricula, id: id }]);
    };
    ListadoConsultaPage.prototype.getConsultas = function () {
        this.consultas = this.BD.ListadoConsultas;
    };
    ListadoConsultaPage.prototype.onSearchTerm = function (ev) {
        var val = ev.detail.value;
        if (val && val.trim() !== '') {
            this.consultas = this.consultas.filter(function (term) {
    ...
    ListadoConsultaPage.ctorParameters = function () { return [
...
//# sourceMappingURL=listado-consulta-listado-consulta-module-es5.js.map