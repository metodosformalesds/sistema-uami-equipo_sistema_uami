...
var MenuPage = /** @class */ (function () {
    ...
    MenuPage.prototype.ngOnInit = function () {
        var _this = this;
        this.BD.rol();
        setTimeout(function (a) { return _this.getRol(); }, 500);
    };
    MenuPage.prototype.goToListadoMedicamento = function () {
        this.navCtrl.navigateForward('listado-medicamento');
    };
    MenuPage.prototype.goToListadoPaciente = function () {
        this.navCtrl.navigateForward('listado-paciente');
    };
    MenuPage.prototype.goToListadoConsulta = function () {
        this.navCtrl.navigateForward('listado-consulta');
    };
    MenuPage.prototype.goToRegistroPaciente = function () {
        this.navCtrl.navigateForward('registro-paciente');
    };
    MenuPage.prototype.goToRegistroUsuario = function () {
        this.navCtrl.navigateForward('registro-usuario');
    };
    MenuPage.prototype.goToReporte = function () {
        this.navCtrl.navigateForward('reporte');
    };
    MenuPage.prototype.getRol = function () {
    ...
    MenuPage.prototype.logout = function () {
        var _this = this;
        this.BD.logoutUser().then(function (a) { return _this.navCtrl.navigateRoot('home'); });
    };
